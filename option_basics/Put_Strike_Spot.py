...
# ============================================================
# Save the figure in folder "plot_options_strat" (local to this directory)
# ============================================================
script_dir = os.path.dirname(os.path.abspath(__file__))
plots_dir = os.path.join(script_dir, "plots")
os.makedirs(plots_dir, exist_ok=True)  # create folder if needed
output_file = os.path.join(plots_dir, "put_value_decomposition_convex.png")
